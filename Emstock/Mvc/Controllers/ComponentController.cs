...
namespace Mvc.Controllers
{
    public class ComponentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Number")] Component component)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number")] Component component)
        {
            if (id != component.Id)
            {
                return NotFound();
